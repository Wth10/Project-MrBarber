                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            <thead>
                                ...
                                <tr>
                                    <th>15:30 - 05/11/2021</th>
                                    <th>BARBER SHOP T.H.R</th>
                                    <th>Corta Cabelo(Maquina)</th>
                                    <th>João Pedro</th>
                                    <th style="color: red;">Pendente</th>
                                    <th>
                                        <a type="button"  target="_blank" href="https://goo.gl/maps/cCSovc5TNAd4Di926" class="btn btn-primary btn-sm">ABRIR MAPA</a>
                                    </th>
                                    <th>    
                                        <a type="button" target="_blank" href="https://www.whatsapp.com/?lang=pt_br" class="btn btn-primary btn-sm">Falar Com Profissional</a> 
                                    </th>
                                    <th>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#popupFuncionario">Cancelar</button>
                                    </th>
                                </tr> 
                            <tbody>
                            </tbody>
                ...
                <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page" href="../PaginasProfissional/PagFuncionario.php">
                                    <span data-feather="users"></span> Funcionarios
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            <thead>
                                ...
                                <tr>
                                    <th>Manoel Santos</th>
                                    <th>Corta Cebelo(Tesoura)</th>
                                    <th>13:00 - 05/11/2021</th>
                                    <th>João</th>
                                    <th style="color: red;">Pendente</th>
                                    <th>
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#popupFuncionario">Cliente</button>
                                    </th>
                                    <th>
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#popupFuncionario">Concluír</button>
                                    </th>
                                </tr> 
                            <tbody>
                            </tbody>
...
<!-- FIM DA PAGINA PROFISSIONAL -->


<!-- PAGINA DO FUNCIONARIO -->
                        ...
                        <table class="table table-striped table-sm">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="color: red;">Pendente</th>
                                    <th>    
                                        <a type="button" href="" class="btn btn-primary btn-sm">Cliente</a> 
                                    </th>
                                    <th>
                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#popupFuncionario">Concluír</button>
                                    </th>
                                    <th>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#popupFuncionario">Cancelar</button>
                                    </th>
                    ...
                    <div class="modal-dialog modal-lg  modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="#" class="form-agendamento">
                                    <div class="row g-3 align-items-center">                 
                                        <input type="text" class="form-control" id="data" placeholder="Nome Cliente">  
                                        <input type="text" class="form-control" id="data" placeholder="Telefone">         
                                        <div class="col-sm-6">
                                            <input type="date" min="<?php echo date('Y-m-d');?>" max="2021-12-25" class="form-control" id="data" placeholder="Data">
                                        </div>
                                        <div class="col-sm-6">
